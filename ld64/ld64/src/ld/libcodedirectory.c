...
#if __has_extension(blocks) || defined(USE_BLOCKS)
...
struct _libcd {
    ...
    SLIST_HEAD(dummy1, _raw_blob) raw_blobs;
    SLIST_HEAD(dummy2, _sslot_data) sslot_data;
