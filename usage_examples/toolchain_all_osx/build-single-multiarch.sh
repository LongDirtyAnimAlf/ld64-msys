...
INSTALLPREFIX=$TARGETDIR ./buildall.sh
popd &>/dev/null
popd &>/dev/null
...
mkdir -p ld64
pushd ld64 &>/dev/null
../../../../ld64/configure --prefix=$TARGETDIR --with-libtapi=$TARGETDIR CXXFLAGS="-Wl,--allow-multiple-definition" CFLAGS="-D_GNU_SOURCE -fcommon"
